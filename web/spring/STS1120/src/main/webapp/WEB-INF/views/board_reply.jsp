  ...
  >
    ...
    <td width=100 id="rwriter${rdto.rhobby_idx}"> ${rdto.rwriter}  </td> 
 	...
 	<td width=250 id="rbt${rdto.rhobby_idx}" align="right"> 
 	   <input type="button" onclick="location.href='boardreply_delete.sp?Ridx=${rdto.rhobby_idx}&idx=${rdto.hobby_idx}'" value="삭제">
